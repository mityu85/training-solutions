package iozip.transaction;

import iozip.transactions.Transaction;
import iozip.transactions.TransactionFileManager;
...
public class TransactionFileManagerTest {
    ...
    public void testSaveTransactions() throws IOException {
        ...
        Path path = Path.of("src/main/resources/trans.zip");
